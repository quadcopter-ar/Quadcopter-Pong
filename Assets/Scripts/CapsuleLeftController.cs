...
public class CapsuleLeftController : MonoBehaviour
{
    public int score = 0;
    public float speed;
    ...
    public bool keyboardDebugLeft = false;
        ...
        if (!keyboardDebugLeft)
        {
            ...
            */
            ...
            if (controller.TryGetFeatureValue(primary2DVector, out primary2dValue) && primary2dValue != Vector2.zero)
            {
                ...
                if (primary2dValue.y > 0.0f)
                {
                    //Vector3 up = transform.TransformDirection(Vector3.up);
                    transform.Translate(new Vector3(speed * Time.deltaTime * primary2dValue.y ,0,0));
                }
                ...
                if (primary2dValue.x < 0.0f)
                {
                    //Vector3 left = transform.TransformDirection(Vector3.left);
                    transform.Translate(new Vector3(0, speed * Time.deltaTime * primary2dValue.x ,0));
                }
